...
class Collections:
    ...
    """
    def __init__(self, use_caching=False, cache_name="collections_cache", backend="sqlite", expire_after=3600):
        self.endpoint = "grscicoll/collection"
          
        if use_caching:
            requests_cache.install_cache(cache_name, backend=backend, expire_after=expire_after)
      
    def list_all_collections(self, content_types: Optional[str]=None,
    ...
    def export_collections(self, data_format="TSV", content_types: Optional[str]=None,
                             preservtion_types: Optional[str]=None,
                             accession_status: Optional[str]=None,
                             personal_collection: Optional[bool]=None,
                             code: Optional[str]=None,
