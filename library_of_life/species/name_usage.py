...
class NameUsage:
    ...
    def get_usage_vernacular_names_by_usage_key(
        self, usage_key, limit: Optional[int] = None, offset: Optional[int] = None
    ):
        """
    ...
    def get_synonyms_by_usage_key(
        ...
        try:
            return hc.get_with_params(
                base_url + self.endpoint + resource, params=params, headers=headers
            )
        except JSONDecodeError:
            response = hc.get_for_content_with_params(
                base_url + self.endpoint + resource, params=params, headers=headers
    ...
    def get_name_usage_species_profiles_by_usage_key(
        self, usage_key, limit: Optional[int] = None, offset: Optional[int] = None
    ):
        """
    ...
    def get_related_name_usages_by_usage_key(
        self, usage_key, limit: Optional[int] = None, offset: Optional[int] = None
    ):
        """
    ...
    def get_references_by_usage_key(
        self, usage_key, limit: Optional[int] = None, offset: Optional[int] = None
    ):
        """
    ...
    def get_name_usage_media_by_usage_key(
        self, usage_key, limit: Optional[int] = None, offset: Optional[int] = None
    ):
        """
    ...
    def get_identifiers_by_usage_key(
        self, usage_key, limit: Optional[int] = None, offset: Optional[int] = None
    ):
        """
    ...
    def get_name_usage_distributions_by_usage_key(
        self, usage_key, limit: Optional[int] = None, offset: Optional[int] = None
    ):
        """
    ...
    def get_name_usage_descriptions_by_usage_key(
        self, usage_key, limit: Optional[int] = None, offset: Optional[int] = None
    ):
        """
    ...
    def get_name_usage_children_by_usage_key(
        self,
        usage_key,
        language,
        limit: Optional[int] = None,
    ...
    def get_root_name_usage_for_dataset(
        self,
        dataset_key,
        language,
        limit: Optional[int] = None,
