...
class GADMRegions:
    ...
    def get_3rd_level_gadm_subdivisions(
        self, level0, level1, level2, query: Optional[str] = None
    ):
        """
    ...
    def get_2nd_level_gadm_subdivisions(
        self, level0, level1, query: Optional[str] = None
    ):
        """
